...
public class Vusched_Schedule_A1ECF7B48FCD4090C9BBE33261613362
		extends com.ibm.rational.test.lt.kernel.action.impl.Schedule {

	public Vusched_Schedule_A1ECF7B48FCD4090C9BBE33261613362(IContainer parent, String name) {
		super(parent, name, "A1ECF7B48FCD4090C9BBE33261613362");
		super.actualScheduleName = "vusched";
		setThinkMax(10000);
